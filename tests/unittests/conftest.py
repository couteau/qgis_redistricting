...
@pytest.fixture
def active_plan(mocker: MockerFixture):
...
@pytest.fixture
def mock_updater(mocker: MockerFixture) -> services.DistrictUpdater:
...
@pytest.fixture
def mock_assignments_service(mocker: MockerFixture) -> services.AssignmentsService:
