...
class Ui_dlgImportShapefile(object):
    ...
    def retranslateUi(self, dlgImportShapefile):
        ...
        self.cmbDistField.setToolTip(_translate("dlgImportShapefile", "Shapefile attribute containing the district number"))
        self.lblShapefile.setText(_translate("dlgImportShapefile", "&Shapefile"))
        self.cmbNameField.setToolTip(_translate("dlgImportShapefile", "Shapefile attribute containing the district name"))
        ...
        self.cmbMembersField.setToolTip(_translate("dlgImportShapefile", "Shapefile attribute containing the number of members in the district"))
